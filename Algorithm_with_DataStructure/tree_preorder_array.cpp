...
// 트리를 배열로 나타내기 위해서, 배열의 인덱스를 사용하는 전위 순회 함수 정의
void preorderTraversal(int tree[], int index, int size) {
    ...
    preorderTraversal(tree, 2 * index, size);
